              ...
              <div className="sm:flex sm:items-start">
                ...
                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                  <DialogTitle as="h3" className="text-base font-semibold text-gray-900">
                    Yeni besin başarıyla kaydedilmiştir!
                  </DialogTitle>
                  <div className="mt-2">
                    <p className="text-sm text-gray-500">
                      Yeni besininizi hemen şimdi yayımlamak ister misiniz ?
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
              ...
              >
                ...
                <button
                  ...
                  className="inline-flex w-full justify-center rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 sm:ml-3 sm:w-auto"
                >
