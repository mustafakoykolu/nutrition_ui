export default function Comments(){
    return(
        <section className="py-24 relative shadow-xl rounded-3xl bg-white mx-10">
        <div className="w-full max-w-7xl px-4 md:px-5 lg:px-5 mx-auto">
            <div className="w-full flex-col justify-start items-start lg:gap-14 gap-7 inline-flex">
                <h2 className="w-full text-gray-900 text-4xl font-bold font-manrope leading-normal">Yorumlar</h2>
                <div className="w-full flex-col justify-start items-start gap-5 flex">
                    <div className="w-full rounded-3xl justify-start items-start gap-3.5 inline-flex">
                        ...
                        <textarea name="" rows={5} className="w-full px-5 py-3 rounded-2xl border border-gray-300 shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] resize-none focus:outline-none placeholder-gray-400 text-gray-900 text-lg font-normal leading-7" placeholder="İlham verici düşüncelerini insanlarla paylaş...."></textarea>
                    </div>
                    <button className="px-5 py-2.5 bg-indigo-600 hover:bg-indigo-800 transition-all duration-700 ease-in-out rounded-xl shadow-[0px_1px_2px_0px_rgba(16,_24,_40,_0.05)] justify-center items-center flex">
                        <span className="px-2 py-px text-white text-base font-semibold leading-relaxed">Yorum yap</span>
                    </button>
                </div>
                <div className="w-full flex-col justify-start items-start gap-8 flex">
                        ...
                        <div className="w-full flex-col justify-start items-start gap-3.5 inline-flex">
                            <div className="w-full justify-start items-start flex-col flex gap-1">
                                <div className="w-full justify-between items-start gap-1 inline-flex">
                                    <h5 className="text-gray-900 text-sm font-semibold leading-snug">Ahmet Şef</h5>
                                    <span className="text-right text-gray-500 text-xs font-normal leading-5">10 saat önce</span>
                                </div>
                                <h5 className="text-gray-800 text-sm font-normal leading-snug">Gerçekten nefis bir tarif olmuş ellerine sağlık.</h5>
                            </div>
                            <div className="justify-start items-start gap-5 inline-flex">
                                <a href="" className="w-5 h-5 flex items-center justify-center group">
                                    <svg className="text-indigo-600 group-hover:text-indigo-800 transition-all duration-700 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <div className="w-full pb-6 border-b border-gray-300 justify-start items-start gap-2.5 inline-flex">
                        <img className="w-10 h-10 rounded-full object-cover" src="https://pagedone.io/asset/uploads/1710238051.png" alt="Emma Davis image" />
                        <div className="w-full flex-col justify-start items-start gap-3.5 inline-flex">
                            <div className="w-full justify-start items-start flex-col flex gap-1">
                                <div className="w-full justify-between items-start gap-1 inline-flex">
                                    <h5 className="text-gray-900 text-sm font-semibold leading-snug">Hakan Şef</h5>
                                    <span className="text-right text-gray-500 text-xs font-normal leading-5">2 gün önce</span>
                                </div>
                                <h5 className="text-gray-800 text-sm font-normal leading-snug">Mustafa güzel bir içerik olmuş. Bir çok arkadaşımıza katkı sağlayacağını düşünüyorum. Ama pişme süresi biraz fazla olmamış mı. Kekik ve nane de eklersen lezzet şöleni yaşanabilir.</h5>
                            </div>
                            <div className="justify-start items-start gap-5 inline-flex">
                                <a href="" className="w-5 h-5 flex items-center justify-center group">
                                    <svg className="text-indigo-600 group-hover:text-indigo-800 transition-all duration-700 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
                    ...
                    <div className="w-full pb-6 border-b border-gray-300 justify-start items-start gap-2.5 inline-flex">
                        <img className="w-10 h-10 rounded-full object-cover" src="https://pagedone.io/asset/uploads/1710225753.png" alt="James Miller image" />
                        <div className="w-full flex-col justify-start items-start gap-3.5 inline-flex">
                            <div className="w-full justify-start items-start flex-col flex gap-1">
                                <div className="w-full justify-between items-start gap-1 inline-flex">
                                    <h5 className="text-gray-900 text-sm font-semibold leading-snug">Mehmet Şef</h5>
                                    <span className="text-right text-gray-500 text-xs font-normal leading-5">5 gün önce</span>
                                </div>
                                <h5 className="text-gray-800 text-sm font-normal leading-snug">Hemen mutfağa koşup denemek için can atıyorum.</h5>
                            </div>
                            <div className="justify-start items-start gap-5 inline-flex">
                                <a href="" className="w-5 h-5 flex items-center justify-center group">
                                    <svg className="text-indigo-600 group-hover:text-indigo-800 transition-all duration-700 ease-in-out" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
